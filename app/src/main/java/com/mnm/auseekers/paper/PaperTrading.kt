...
class PaperTradingLedger(
    ...
    fun close(
        ...
        val closed = ClosedPaperTrade(
            ...
            exitPrice = exitPrice,
            pointSize = position.pointSize,
            valuePerPointPerLot = position.valuePerPointPerLot,
            plannedStopPoints = position.plannedStopPoints,
            maximumPlannedLoss = position.maximumPlannedLoss,
